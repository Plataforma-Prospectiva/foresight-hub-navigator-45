-- Add remaining new prospective techniques from the Google Docs document (fixed syntax)
...
'[{"type": "book", "title": "Time Series Analysis and Forecasting", "authors": ["Bowerman", "OConnell"], "year": 2003}]'::jsonb, 'es'),
...
'[{"type": "book", "title": "Time Series Analysis and Forecasting", "authors": ["Bowerman", "OConnell"], "year": 2003}]'::jsonb, 'en'),
